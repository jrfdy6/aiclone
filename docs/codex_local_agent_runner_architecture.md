# RETIRED / HISTORICAL: Pre-Cutover Runner Architecture

> This document records the predecessor design that split execution between
> Codex and OpenClaw. It is not an active implementation contract. OpenClaw,
> Discord, and provider-token execution are retired. Do not build or restore
> the layers, paths, schedules, or delivery flows described below.
>
> Current authority: [SOURCE_OF_TRUTH.md](../SOURCE_OF_TRUTH.md),
> [Codex Runner Schema](./codex_runner_schema.md), and
> [Codex-Native Local Automation Scheduling](../SOPs/codex_native_local_automation_sop.md).

## Archived design record

### Original title: Codex Local Agent Runner Architecture
