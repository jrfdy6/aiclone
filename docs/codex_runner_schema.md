...
Runtime authority: [SOURCE_OF_TRUTH.md](../SOURCE_OF_TRUTH.md). Runners execute
through Codex CLI with the saved ChatGPT login. Railway is only the
authenticated queue/control plane; it does not execute local filesystem work.
Production packets must be signed, action-allowlisted, and contained to a
registered workspace path before a runner may claim or execute them.
...
```json
{
  ...
  "dry_run": false,
  "allowed_paths": [
    "/Users/neo/Documents/Codex/AI-Clone"
  ],
...
- `/Users/neo/Documents/Codex/AI-Clone/memory/runner-ledgers/<runner_id>.jsonl`
...
{
  "kind": "file",
  "path": "/Users/neo/Documents/Codex/AI-Clone/memory/runner-memos/jean-claude/2026-03-31_ops_review.md",
...
Meaningful runner passes may also emit a compact Codex Chronicle payload for local Brain and maintenance jobs.
...
```json
{
  ...
  "workspace_key": "shared_ops",
  "scope": "shared_ops",
  "summary": "Jean-Claude detected that local execution and Brain need one canonical Chronicle bridge.",
  "decisions": [
...
- `/Users/neo/Documents/Codex/AI-Clone/memory/runner-ledgers/jean-claude.jsonl`
- `/Users/neo/Documents/Codex/AI-Clone/memory/runner-ledgers/yoda.jsonl`
- `/Users/neo/Documents/Codex/AI-Clone/memory/runner-memos/jean-claude/`
- `/Users/neo/Documents/Codex/AI-Clone/memory/runner-memos/yoda/`

Optional later:
- `/Users/neo/Documents/Codex/AI-Clone/memory/runner-ledgers/index.json`
...
- unsigned or tampered production packet
- requested path outside the registered workspace allowlist
- unrecognized action or command prefix
- provider/API credentials inherited by the Codex subprocess
