...
- `/Users/neo/Documents/Codex/AI-Clone/docs/codex_runner_schema.md`
...
- receiving direct user intake and authenticated Railway control-plane requests
...
- The authenticated Railway PM board is the remote intake, approval, queue, and write-back surface.
- Repository-owned launchd workers claim bounded work and execute from `/Users/neo/Documents/Codex/AI-Clone`.
- Private service tokens, job-signing keys, logs, and automation ledgers live under `/Users/neo/.codex/ai-clone`.
- Neo may route work, but write-capable execution requires the downstream runner to validate the signed PM work order and its repository/path allowlist.

See [SOURCE_OF_TRUTH.md](/Users/neo/Documents/Codex/AI-Clone/SOURCE_OF_TRUTH.md) and [codex_native_local_automation_sop.md](/Users/neo/Documents/Codex/AI-Clone/SOPs/codex_native_local_automation_sop.md).
