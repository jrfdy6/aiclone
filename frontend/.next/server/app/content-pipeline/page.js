(()=>{var e={};e.id=406,e.ids=[406],e.modules={2934:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4635:(e,t,o)=>{"use strict";o.r(t),o.d(t,{GlobalError:()=>a.a,__next_app__:()=>u,originalPathname:()=>c,pages:()=>p,routeModule:()=>h,tree:()=>d}),o(4588),o(1506),o(5866);var n=o(3191),r=o(8716),i=o(7922),a=o.n(i),s=o(5231),l={};for(let e in s)0>["default","tree","pages","GlobalError","originalPathname","__next_app__","routeModule"].indexOf(e)&&(l[e]=()=>s[e]);o.d(t,l);let d=["",{children:["content-pipeline",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(o.bind(o,4588)),"/Users/neo/.openclaw/workspace/downloads/aiclone/frontend/app/content-pipeline/page.tsx"]}]},{}]},{layout:[()=>Promise.resolve().then(o.bind(o,1506)),"/Users/neo/.openclaw/workspace/downloads/aiclone/frontend/app/layout.tsx"],"not-found":[()=>Promise.resolve().then(o.t.bind(o,5866,23)),"next/dist/client/components/not-found-error"]}],p=["/Users/neo/.openclaw/workspace/downloads/aiclone/frontend/app/content-pipeline/page.tsx"],c="/content-pipeline/page",u={require:o,loadChunk:()=>Promise.resolve()},h=new n.AppPageRouteModule({definition:{kind:r.x.APP_PAGE,page:"/content-pipeline/page",pathname:"/content-pipeline",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:d}})},237:(e,t,o)=>{Promise.resolve().then(o.bind(o,9116))},1221:()=>{},2109:(e,t,o)=>{Promise.resolve().then(o.t.bind(o,2994,23)),Promise.resolve().then(o.t.bind(o,6114,23)),Promise.resolve().then(o.t.bind(o,9727,23)),Promise.resolve().then(o.t.bind(o,9671,23)),Promise.resolve().then(o.t.bind(o,1868,23)),Promise.resolve().then(o.t.bind(o,4759,23))},9116:(e,t,o)=>{"use strict";o.r(t),o.d(t,{default:()=>c});var n=o(326),r=o(7577),i=o(8528),a=o(5061);(0,i.kG)();let s={value:{ratio:9,description:"Pure value. Teaching, insights, observations. No selling mixed in.",icon:"\uD83D\uDCDA",color:"from-blue-600 to-cyan-600",bgColor:"bg-blue-900/30",borderColor:"border-blue-500"},sales:{ratio:1,description:"Sell unabashedly. \"I'm building X. Here's how to get involved.\"",icon:"\uD83D\uDCB0",color:"from-green-600 to-emerald-600",bgColor:"bg-green-900/30",borderColor:"border-green-500"},personal:{ratio:1,description:"Personal/behind-the-scenes. The real me, struggles included.",icon:"\uD83D\uDE4B",color:"from-purple-600 to-pink-600",bgColor:"bg-purple-900/30",borderColor:"border-purple-500"}},l={problem:{label:"Problem",description:"Identify the pain point",icon:"\uD83C\uDFAF"},amplify:{label:"Amplify",description:"Make the problem feel urgent",icon:"\uD83D\uDCE2"},credibility:{label:"Credibility",description:"Show why you're qualified",icon:"\uD83C\uDFC6"},educate:{label:"Educate",description:"Provide value and solutions",icon:"\uD83D\uDCD6"},request:{label:"Request",description:"Clear call to action",icon:"\uD83D\uDC49"}},d={name:"Johnnie Fields",title:"Director of Admissions at Fusion Academy (DC)",northStar:"I can't be put into a box. I'm a work in progress, pivoting into tech and data while leveraging 10+ years in education.",tone:"Expert + direct, inspiring. Process Champion energy."},p=[{value:"cold_email",label:"Cold Email",icon:"\uD83D\uDCE7"},{value:"linkedin_post",label:"LinkedIn Post",icon:"\uD83D\uDCDD"},{value:"linkedin_dm",label:"LinkedIn DM",icon:"\uD83D\uDCAC"},{value:"instagram_post",label:"Instagram Post",icon:"\uD83D\uDCF8"}];function c(){let[e,t]=(0,r.useState)([]),[o,c]=(0,r.useState)("value"),[u,h]=(0,r.useState)(!1),[x,g]=(0,r.useState)(!1),[m,f]=(0,r.useState)([]),[b,y]=(0,r.useState)("linkedin_post"),[v,w]=(0,r.useState)(""),[C,j]=(0,r.useState)(""),[k,S]=(0,r.useState)([]),[I,P]=(0,r.useState)("general"),[D,A]=(0,r.useState)(null),z=e=>{t(e),localStorage.setItem("content_pipeline_911",JSON.stringify(e))};(0,r.useMemo)(()=>{let t=e.filter(e=>"value"===e.category).length,o=e.filter(e=>"sales"===e.category).length,n=e.filter(e=>"personal"===e.category).length;return{value:t,sales:o,personal:n,total:t+o+n}},[e]);let _=t=>e.filter(e=>e.category===t),B=async()=>{g(!0);try{let e=await (0,i.SC)("/api/content-generation/generate",{method:"POST",body:JSON.stringify({user_id:"johnnie_fields",topic:v||"professional growth",context:C||"",content_type:b,category:o,pacer_elements:k.map(e=>e.charAt(0).toUpperCase()+e.slice(1)),tone:"expert_direct",audience:I})}),t=await e.json();if(console.log("API Response:",t),t?.success&&t?.options&&t.options.length>0)f(t.options);else{console.log("API returned no options, using templates");let e=T(o,b,{topic:v,context:C,pacer:k});f(e)}}catch(e){console.error("Content generation error:",e),f(T(o,b,{topic:v,context:C,pacer:k}))}g(!1)},T=(e,t,o)=>{let{topic:n,context:r,pacer:i}=o;if("value"===e){if("linkedin_post"===t)return[`🎯 ${n||"Here's what I learned this week"}:
...
${r||"Working with neurodivergent students"} has reinforced this:
...
Best,
Johnnie`,`Subject: Idea for ${r||"your practice"}
...
After 10+ years in education and pivoting into tech, I'm creating ${n||"Easy Outfit"} - ${r||"a fashion app that helps you use what you have"}.
