...
export function LinkedinWorkspaceSurface({
  ...
  const activeSourceCard = useMemo<WorkspaceSourceCard | null>(() => {
    ...
    if (topicSourceMode === 'suggested_angle') {
      const suggested = snapshot?.weekly_plan?.recommendations?.[0];
  ...
  }, [querySeed.priorityLane, querySourceCard, selectedSignal, snapshot?.weekly_plan?.recommendations, topicSourceMode]);
          ...
          {showGenerator && (
            <div style={generatorPanelStyle}>
              ...
              <p style={{ color: '#64748b', fontSize: '12px', margin: '10px 0 0' }}>
                From the authenticated Railway project UI, Queue Local Codex creates a signed job for the launchd worker on this Mac.
              </p>
                    ...
                    {generatedContent.map((content, index) => (
                      <div key={`generated-${index}`} style={generatedOptionStyle}>
                        ...
                        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
                          ...
                          <button type="button" onClick={() => void handleCopy(content, 'Draft')} style={secondaryActionStyle('#94a3b8')}>
                            Copy
                          </button>
                        </div>
