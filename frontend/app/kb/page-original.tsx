...
import { publicOwnerDisplayName, publicOwnerRoleLabel } from "@/lib/public-profile";

export const dynamic = "force-dynamic";
export const revalidate = 0;

export const metadata: Metadata = {
  title: `${publicOwnerDisplayName} - Digital Knowledge Base`,
  description: "AI-readable knowledge base containing the owner's voice patterns, professional background, and research insights. Optimized for Microsoft Copilot and AI assistants.",
        ...
        <article>
          ...
          <section style={{ marginBottom: "40px" }}>
            ...
            <ul style={{ listStyle: "disc", paddingLeft: "24px", lineHeight: 1.8 }}>
              ...
              <li>
                <Link href="/kb/how-owner-talks-to-parents" style={{ color: "#2563eb", textDecoration: "underline" }}>
                  How the owner communicates with parents
                </Link>
              </li>
            </ul>
          </section>
