#!/usr/bin/env python3
"""Run the deterministic hourly progress pulse launchd job."""
...
from scheduled_automation_tasks import build_progress_pulse
...
def main() -> int:
    ...
    result, ok = run_scheduled_task(
        ...
        task=lambda: build_progress_pulse(timeout_seconds=args.timeout_seconds),
    )
