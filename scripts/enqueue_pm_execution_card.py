...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source", default="codex_native:remote_queue")
...
def build_card_request(args: argparse.Namespace | SimpleNamespace, *, now_iso: str | None = None) -> dict[str, Any]:
    ...
    normalized_reason = str(args.reason or "").strip() or f"Codex queued `{args.title}` through the authenticated Railway work queue."
