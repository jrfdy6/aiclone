...
from linkedin_idea_qualification import load_or_build_idea_qualification_payload  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate the LinkedIn idea qualification artifacts.")
