#!/usr/bin/env python3
"""Print a compact operator context pack for Codex launchd and startup flows."""
...
SECTION_FILES = {
    "sop": [
        ...
        WORKSPACE_ROOT / "SOPs" / "_index.md",
    ],
    "identity": [
        WORKSPACE_ROOT / "IDENTITY.md",
        WORKSPACE_ROOT / "CHARTER.md",
...
def main() -> int:
    ...
    parser.add_argument("--identity", action="store_true", help="Load identity and user context")
    ...
    if not requested:
        requested = ["sop", "identity", "roadmap", "memory"]
