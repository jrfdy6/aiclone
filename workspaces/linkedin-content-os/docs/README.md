...
Use this directory for workspace-local operating docs, architecture plans, and execution references for `feezie-os`.

This is the first local doc anchor OpenClaw should read before drilling into task-specific planning docs inside this lane.
