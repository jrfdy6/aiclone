...
def normalize_promotion_item(item: dict[str, Any], delta: PersonaDelta) -> dict[str, Any] | None:
    ...
    return {
        ...
        "source_capture_id": delta.capture_id,
        "resolution_capture_id": metadata_text(metadata, "resolution_capture_id"),
        "trait": delta.trait,
        ...
        "perspective_lineage_schema": metadata_text(metadata, "perspective_lineage_schema"),
        "perspective_topic_key": metadata_text(metadata, "perspective_topic_key"),
