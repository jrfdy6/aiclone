...
KNOWN_CAPABILITIES = frozenset(
    {
        ...
        "brain.social_engagement_capture/v1",
        "brain.social_engagement_action/v1",
...
SAFE_BRAIN_ACTION_CAPABILITIES = {
    ...
    "social_engagement_capture": "brain.social_engagement_capture/v1",
    "social_engagement_action": "brain.social_engagement_action/v1",
