...
def _local_launchd_automations() -> List[Automation]:
    ...
    return [
        ...
        Automation(
            ...
            description="Always-on local launchd worker dedicated to grounded email drafting jobs so inbox drafts do not compete with the LinkedIn content lane.",
            type="daemon",
            status="active",
            schedule="Always on",
            cron="launchd.keepalive",
            ...
            notes="Local-machine keepalive bridge for restart-safe email draft jobs. It is queue-isolated from the FEEZIE content bridge by workspace slug.",
        ),
        Automation(
            id="watchtranscripts",
