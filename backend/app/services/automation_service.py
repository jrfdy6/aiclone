...
def _static_automations() -> List[Automation]:
    ...
    automations: List[Automation] = [
        ...
        Automation(
            ...
            description="OpenClaw-local automation that refreshes the FEEZIE workspace signal lane, rebuilds weekly planning and reaction artifacts, and materializes owner-review drafts in the LinkedIn workspace.",
            type="scheduled",
            status="active",
            schedule="Every 2 hours",
            cron="0 */2 * * *",
