...
from app.services.social_owner_perspective_service import social_owner_perspective_service
...
def build_generation_context(signal: dict[str, Any], lane_id: str) -> dict[str, Any]:
    ...
    owner_perspective = social_owner_perspective_service.build(
        signal=signal,
        lane_id=lane_id,
        article_understanding=article_understanding,
        persona_retrieval=persona_retrieval,
    ...
    reaction_brief = social_reaction_brief_service.build(
        ...
        article_understanding=article_understanding,
        persona_retrieval=persona_retrieval,
        owner_perspective=owner_perspective,
    )
...
def build_variants(signal: dict[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    for lens_id in LENS_IDS:
        ...
        stage_evaluation = social_stage_evaluation_service.evaluate_variant(
            ...
            owner_perspective=context.get("owner_perspective"),
        ...
        variants[lens_id] = {
            ...
            "context_snapshot": {
                ...
                "owner_view": (context.get("reaction_brief") or {}).get("owner_view", ""),
