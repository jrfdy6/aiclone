...
class SocialResponseTypeService:
    def select(
        ...
        *,
        ...
        role_safety = _normalize_inline_text(signal.get("risk_level") or owner_perspective.get("role_safety") or "safe").lower()
        lived_addition = _normalize_inline_text(owner_perspective.get("lived_addition"))
        pushback = _normalize_inline_text(owner_perspective.get("pushback"))
        agree_with = _normalize_inline_text(owner_perspective.get("agree_with"))
        stance = _normalize_inline_text(owner_perspective.get("stance")).lower()
