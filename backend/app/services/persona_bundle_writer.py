...
SEED_CLAIMS = [
    {
        "claim": "No owner-specific claim has been promoted yet.",
        "type": "placeholder",
        "evidence": "A private, human-reviewed persona source is required.",
        "usage_rule": "Do not publish this placeholder or infer a personal claim from it.",
    },
]

SEED_STORIES = [
    {
        "title": "Private story required",
        "story_type": "placeholder",
        "use_when": "Never use in published content.",
        "core_point": "Add a reviewed story through the private persona workflow.",
    },
]

SEED_INITIATIVES = [
    {
        "title": "Private initiative required",
        "status": "unconfigured",
        "purpose": "Add a reviewed initiative through the private persona workflow.",
        "value": "",
        "proof": "",
        "use_when": "Never use in published content until reviewed evidence is attached.",
    },
]

SEED_WINS = [
    "No owner-specific win has been promoted. Add reviewed proof through the private persona workflow.",
]
...
def _default_file_content(rel_path: str) -> str:
    ...
    if rel_path == "identity/bio_facts.md":
        return _frontmatter("Bio Facts", rel_path) + _render_sectioned_list(
            ...
            {"Facts": ["No biographical facts have been promoted from the private persona workflow."]},
        )
    ...
    if rel_path == "history/resume.md":
        return _frontmatter("Resume", rel_path) + _render_sectioned_list(
            ...
            {"Experience": ["No resume evidence has been promoted from the private persona workflow."]},
        )
    if rel_path == "history/timeline.md":
        return _frontmatter("Timeline", rel_path) + _render_sectioned_list(
            ...
            {"Milestones": ["No milestones have been promoted from the private persona workflow."]},
        )
