...
_MOUNTED_API_PREFIXES = frozenset(
    {
        ...
        "/api/standups",
        "/api/system/logs",
        "/api/system/firestore-readiness",
        "/api/system/railway-retention",
        "/api/timeline",
...
_SURFACE_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "backend_contract_prefixes": [],
        "fallback_policy": "redirect_to_canonical",
        "source_of_truth": "compatibility_route+prospects",
        "notes": "Retired page family that redirects to the canonical owner-controlled Prospects surface.",
    },
    {
        ...
        "backend_contract_prefixes": [],
        "fallback_policy": "redirect_to_canonical",
        "source_of_truth": "compatibility_route+workspace",
        "notes": "Retired template page that redirects to the canonical Workspace writer.",
    },
    {
        ...
        "backend_contract_prefixes": [],
        "fallback_policy": "redirect_to_canonical",
        "source_of_truth": "compatibility_route+ops",
        "notes": "Retired dashboard entry point that redirects to canonical Ops health and readiness.",
    },
    {
        "surface_id": "vault",
        "label": "Vault",
        ...
        "backend_contract_prefixes": [],
        "fallback_policy": "redirect_to_canonical",
        "source_of_truth": "compatibility_route+brain_docs",
        "notes": "Retired vault page that redirects to the authenticated Brain Docs surface.",
    },
    {
        ...
        "backend_contract_prefixes": [],
        "fallback_policy": "redirect_to_canonical",
        "source_of_truth": "compatibility_route+brain_briefs",
        "notes": "Retired task page that redirects to the canonical Brain Briefs surface.",
    },
)
