...
> Authority: active procedure subordinate to [SOURCE_OF_TRUTH.md](../SOURCE_OF_TRUTH.md). Confirm status in the [SOP Index](./_index.md).
...
## Procedure
1. `cd /Users/neo/Documents/Codex/AI-Clone`
